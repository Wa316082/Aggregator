            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <form id="form" action="{{ url('order/store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="given_order_id" class="form-control"
                                                        name="given_order_id" value="{{ old('given_order_id') }} ">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" id="customer_mobile" class="form-control"
                                                        name="customer_mobile" value="{{ old('customer_mobile') }}">
                                                    <span class="error text-danger d-none"></span>
                                            ...
                                            {{-- <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        <label for="simpleinput">Actual Amount</label>
                                                        <input type="text" id="actual_amount" class="form-control"
                                                               name="actual_amount" value="{{ old('actual_amount') }}">
                                        <span class="error text-danger d-none"></span>
                                        @error('actual_amount')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control overflow-auto h-auto" id="delivery_address" rows="1" name="delivery_address"
                                                        {{ old('delivery_address') }} required>
                                                    ...
                                                    <select class="form-control set" id="delivery_country_id"
                                                        ...
                                                        @foreach ($locations as $country)
                                                            <option value="{{ $country->id }}"
                                                                ...
                                                                {{ old('delivery_country_id') == $country->id ? 'selected' : '' }}>
                                                                {{ $country->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="error text-danger d-none"></span>
                                            ...
                                            {{-- <div class="col-lg-4 ">
                                                <div class="form-group mb-3">
                                                    <label for="logistic_id">Select Logistics</label>

                                                    <select name="logistic_id" id="logistic_id" class="form-control logistic_id">
                            ...
                            @enderror
                                            ...
                                            <div class="col-lg-4 m-auto">
                                                <a class="btn font-weight-bold  " id="add"><i
                                                        class="fa-solid fa-location-crosshairs text-success"></i> Or Add
                                                    One</a>
                                            </div>
                                            ...
                                            <div class=" row px-2" style="display:none;" id="open">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        <label for="pickup_division_id">Pickup State/Division</label>
                                                        <select class="form-control pickup_divset" id="pickup_division_id"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        <label for="pickup_district_id">Pickup Region/District</label>
                                                        <select class="form-control pickup_disset" id="pickup_district_id"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        <label for="pickup_thana_id">Pickup Thana</label>
                                                        <select class="form-control thanaset_pickup" id="pickup_thana_id"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        <label for="pickup_area_id">Pickup Area</label>
                                                        <select class="form-control " id="pickup_area_id" example
                                                            name="pickup_area_id">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        <label for="pickup_post_code">Post Code</label>
                                                        <input type="text" id="pickup_post_code" class="form-control"
                                                            name="pickup_post_code" value="{{ old('post_code') }}">
                                                        <span class="error text-danger d-none"></span>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea class="form-control" id="pickup_address" rows="2" name="pickup_address">
                                {{ old('pickup_address') }}
                                </textarea>
                                                        <span class="error text-danger d-none"></span>
                                        ...
                                        <div class=" add_box">
                                            <div class="row form-group px-1 ">
                                                ...
                                                <select name="box_size_id" id="boxes"
                                                ...
                                                <input type="text" id="gross_weight"
                                                    ...
                                                    placeholder="Gross Weight" name="gross_weight" value="">
                                                <span class="error text-danger d-none"></span>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <div class="card-deck ">
                                <div id="elephant-card" class="card select-redio mb-4">
                                    <div class="card-body" role="button">
                                        <h5 class="card-title"><input id="elephant" type="radio">
                                            <label for="elephant">Elephant</label></h5>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                                <div id="lion-card" class="card mb-4 active select-redio">
                                    <div class="card-body" role="button">
                                        <h5 class="card-title"><input id="lion" type="radio" checked=""> <label for="lion">Lion</label></h5>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                                <div id="zebra-card" class="card mb-4 select-redio ">
                                    <div class="card-body" role="button">
                                        <h5 class="card-title"><input id="zebra" type="radio"> <label for="zebra">Zebra</label></h5>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                                <div class="w-100"></div>
                                <div id="giraffe-card" class="card mb-4 select-redio ">
                                    <div class="card-body" role="button">
                                        <h5 class="card-title"><input id="giraffe" type="radio"> <label for="giraffe">Giraffe</label></h5>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                                <div id="hyena-card" class="card mb-4 select-redio ">
                                    <div class="card-body" role="button">
                                        <h5 class="card-title"><input id="hyena" type="radio"> <label for="hyena">Hyena</label></h5>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
                                <div id="meerkat-card" class="card mb-4 select-redio ">
                                    <div class="card-body" role="button">
                                        <h5 class="card-title"><input id="meerkat" type="radio"> <label for="meerkat">Meerkat</label></h5>
                                        <p class="card-text">It is a long established fact that a reader will be
                                            distracted by the readable content of a page when looking at its layout.</p>
                                    </div>
                                </div>
